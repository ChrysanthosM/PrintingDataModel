...
public class LetterSetUpTable extends AbstractTable {
    public LetterSetUpTable() {
        ...
        setDbFs(REC_ID, LETTER_TYPE, SEQ_NO, LETTER_TYPE, XSL_TYPE, RENDER_TYPE, VALID_FLAG);
    }
    ...
    public final PairOfTableField RENDER_TYPE = getPairOfTableField(DbField.RENDER_TYPE);
