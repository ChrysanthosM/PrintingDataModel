...
public class LetterSetUpTable extends AbstractTable {
    public LetterSetUpTable() {
        ...
        setDbFs(REC_ID, LETTER_TYPE, SEQ_NO, LETTER_TYPE, XSL_TYPE, RENDERER_TYPE, VALID_FLAG);
    }
    ...
    public final PairOfTableField RENDERER_TYPE = getPairOfTableField(DbField.RENDERER_TYPE);
